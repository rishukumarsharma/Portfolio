...
export const FloatingLabelInput = ({
    ...
    const inputClasses = cn(
        ...
        error ? 'focus:shadow-[0_0_0_3px_rgba(239,68,68,0.1)]' : 'focus:shadow-[0_0_0_3px_rgba(217,70,239,0.1)]',
        className
    );
        ...
        <div className="relative">
            ...
            <motion.label
                ...
                className={cn(
                    ...
                    error ? 'text-red-400' : isFocused ? 'text-accent-400' : 'text-neutral-500'
                )}
                animate={{
