export const placeholderImages = {
  hero: {
    ...
    mobile:
      "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=768&h=1024&fit=crop",
  },
  projects: {
    saas1:
...
export const getPlaceholder = (
  ...
  key?: string,
): string | (typeof placeholderImages)[PlaceholderCategory] => {
  if (
    key &&
    typeof placeholderImages[category] === "object" &&
    key in placeholderImages[category]
  ) {
...
export const getProjectPlaceholder = (category?: string): string => {
  ...
  if (normalized.includes("landing") || normalized.includes("ecommerce"))
    return placeholderImages.projects.landing1;
  if (normalized.includes("webapp") || normalized.includes("web"))
    return placeholderImages.projects.webapp1;
  if (normalized.includes("mobile") || normalized.includes("app"))
    return placeholderImages.projects.mobile1;
