...
export const defaultSEO: SEOConfig = {
    ...
    description: 'Portfolio showcasing user-centered design solutions for SaaS, CRM, and enterprise applications. Specialized in UX research, design systems, and product strategy.',
