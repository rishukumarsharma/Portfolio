...
export const ProjectsShowcase = () => {
    return (
        <div className="min-h-screen bg-neutral-950 py-24">
                ...
                <div className="text-center mb-16">
                    ...
                    <SectionReveal animation="fadeUp" delay={0.2}>
                        <Body size="lg" muted maxWidth="lg" className="mx-auto">
                            ...
                            design challenges through research, iteration, and user-centered thinking.
                        </Body>
                    </SectionReveal>
                </div>
            ...
            {/* Alternative Layouts Demo */}
            <Container className="mt-32">
                <div className="mb-12">
                    <Caption label accent className="mb-4">
                        Grid Layout
                    </Caption>
                    <H2>Standard Grid View</H2>
                </div>
                <ProjectGrid layout="grid" showFilters={false} />
            </Container>
            ...
            <Container className="mt-32">
                <div className="mb-12">
                    ...
                    <H2>Masonry Column View</H2>
                </div>
                <ProjectGrid layout="masonry" showFilters={false} />
            </Container>
        </div>
    );
};
