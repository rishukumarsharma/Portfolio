            ...
            <section className="py-24 bg-neutral-900 overflow-hidden">
                <Container>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {(['fadeUp', 'fadeDown', 'fadeLeft', 'fadeRight', 'scale', 'blur', 'slideUp', 'rotate'] as const).map(
                            (animation, index) => (
                                <SectionReveal
                                    key={animation}
                                    animation={animation}
                    ...
                    <div className="space-y-8">
                        <SectionReveal animation="fadeUp" delay={0.1}>
                            <div className="p-6 bg-neutral-800/50 rounded-xl border border-neutral-700">
                                <Caption className="mb-4 block text-neutral-500">H1 - Display Heading</Caption>
                        ...
                        <SectionReveal animation="fadeUp" delay={0.15}>
                            <div className="p-6 bg-neutral-800/50 rounded-xl border border-neutral-700">
                                <Caption className="mb-4 block text-neutral-500">H2 - Section Heading</Caption>
                        ...
                        <SectionReveal animation="fadeUp" delay={0.2}>
                            <div className="p-6 bg-neutral-800/50 rounded-xl border border-neutral-700">
                                <Caption className="mb-4 block text-neutral-500">H3 - Subsection Heading</Caption>
                        ...
                        <SectionReveal animation="fadeUp" delay={0.25}>
                            <div className="p-6 bg-neutral-800/50 rounded-xl border border-neutral-700">
                                <Caption className="mb-4 block text-neutral-500">H1 with Gradient</Caption>
                        ...
                        <SectionReveal animation="fadeUp" delay={0.3}>
                            <div className="p-6 bg-neutral-800/50 rounded-xl border border-neutral-700">
                                <Caption className="mb-4 block text-neutral-500">Body Text</Caption>
                                <Body size="lg" className="mb-2">Large body text for emphasis</Body>
                                <Body className="mb-2">Regular body text for content</Body>
                                <Body size="sm" muted>Small muted text for secondary info</Body>
                            </div>
                        </SectionReveal>

                        <SectionReveal animation="fadeUp" delay={0.35}>
                            <div className="p-6 bg-neutral-800/50 rounded-xl border border-neutral-700">
                                <Caption className="mb-4 block text-neutral-500">Caption & Labels</Caption>
                                <div className="flex flex-wrap gap-4">
                                    <Caption>Regular Caption</Caption>
                                    <Caption accent>Accent Caption</Caption>
                                    <Caption label>Label Style</Caption>
                                    <Caption label accent>Accent Label</Caption>
                                </div>
                            </div>
                        </SectionReveal>
                    </div>
