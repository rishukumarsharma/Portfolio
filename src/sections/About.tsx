...
const skills = [
  ...
  {
    category: skillsData.uxMethods.category,
    items: skillsData.uxMethods.items.slice(0, 8),
  },
  {
    category: skillsData.productKnowledge.category,
    items: skillsData.productKnowledge.items,
  },
];
          ...
          <div>
            ...
            <ScrollReveal animation="fadeUp" delay={0.3}>
              <p className="text-body-md text-neutral-400 mb-8">
                Based in {profileData.location}, I specialize in creating
                user-centered designs that solve real problems while delivering
                measurable business value. My approach combines thorough UX
                research with modern design practices to create products that
                users love.
              </p>
            </ScrollReveal>
