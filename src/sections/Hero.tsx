    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(217,70,239,0.25) 0%, rgba(192,38,211,0.15) 40%, transparent 70%)",
          }}
          animate={{
            x: [0, 100, 0],
            y: [0, 50, 0],
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(236,72,153,0.2) 0%, rgba(217,70,239,0.1) 50%, transparent 70%)",
          }}
          animate={{
            x: [0, -80, 0],
            y: [0, -60, 0],
